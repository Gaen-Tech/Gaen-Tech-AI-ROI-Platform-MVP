    ...
    <div className="relative text-gray-100">
      ...
      <div className="relative z-10 container mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50 p-6"><div className="flex items-center justify-between mb-2"><DollarSignIcon className="w-8 h-8 text-pink-400" /><span className="text-xs text-gray-400 uppercase tracking-wider">Pipeline</span></div><div className="text-3xl font-bold text-white">${totalROI.toLocaleString()}</div><p className="text-sm text-gray-400">Total ROI Potential</p></div>
            ...
            {filteredLeads.map((lead) => (
              <div key={lead.id} className="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50 p-6 hover:border-purple-500/50 transition-all duration-300 group">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex items-center justify-between"><div className="flex items-center gap-2 text-gray-400"><DollarSignIcon className="w-4 h-4 text-green-400" /><span className="text-sm">Annual ROI</span></div><span className="text-sm font-bold text-white">$${lead.analysis.estimatedAnnualROI.toLocaleString()}</span></div>
